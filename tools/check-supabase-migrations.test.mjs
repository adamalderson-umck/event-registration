...
describe('validateMigrationDirectory', () => {
  ...
  it('detects a payment_method assignment after a $$ delimiter inside an escape string', () => {
    const directory = createMigrationsDirectory();
    writeMigration(
      directory,
      '20260102000000_tithely_payment_flow.sql',
  ...
  it('detects a payment_method assignment after a tagged delimiter inside an escape string', () => {
    const directory = createMigrationsDirectory();
    writeMigration(
      directory,
      '20260102000000_tithely_payment_flow.sql',
